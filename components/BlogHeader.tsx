...
function BlogHeader() {
    return (
        <div className='w-full p-6 sm:p-12 h-auto flex flex-col-reverse sm:flex-row items-center justify-between bg-[#e8e5ec]'>
    {/** Gauche */}
    <div className="max-w-full px-4 sm:max-w-[624px] sm:px-10 text-center sm:text-left">
    ...
    {/** Droite */}
    <div className='flex items-center justify-center w-full max-w-[500px] mx-auto sm:mr-10'>
        <Image
